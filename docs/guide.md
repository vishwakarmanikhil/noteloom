...
The complete feature reference. Start with the [README](../README.md) for install

- quick start; this covers every built-in feature in depth. Also:
  [`migration.md`](migration.md) · [`stability.md`](stability.md) ·
  [`document.schema.json`](document.schema.json).
